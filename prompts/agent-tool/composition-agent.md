...
> ALWAYS include `type:application`
...
4. (Optional) Apply the portal resources
...
> Make sure to make the instructions to this call as comprehensive as possible. In the request, include the `compositiondefinition.yaml`, `composition.yaml` and `Chart.yaml` files.
